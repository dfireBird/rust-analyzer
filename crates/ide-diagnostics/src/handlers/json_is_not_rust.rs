            ...
            if let Ok(serde_json::Value::Object(it)) = serde_json::from_str(&node_string) {
                ...
                acc.push(
                    ...
                    .with_fixes(Some(vec![{
                        ...
                        {
                            insert_use(&scope, mod_path_to_ast(&it, edition), &config.insert_use, has_name_conflict(serialize_resolved));
                        }
                        ...
                        {
                            insert_use(&scope, mod_path_to_ast(&it, edition), &config.insert_use, has_name_conflict(deserialize_resolved));
                        }
